...
Image sensor That's 15x larger than those Used in Typical smartphones for sharper<br>
              ...
              <button class="btn btn-primary btn-md my-0 p" name="product" onclick="myFunction()" type="submit" style="width: 150px; height: 45px; border-radius: 10px; font-size: medium">&nbsp;Add to cart
...
4K Ultra HD video recording, slow motion up to 120 FPS at 1080p
					 <form  method="post">
              <!-- Default input -->
              <input type="number" name="qty" name="qty" value="1" aria-label="Search" class="auto-style3" style="width: 100px; height:45px; padding: 5px; border-radius: 10px;">
