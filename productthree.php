...
.alert {
  ...
  color: white;
	...
	<div class="container-fluid">
					...
					<div class="col-md-3" style="background-color:#800080;border-radius: 10px;">
										...
										<div class="product">
											...
											<div class="product-body">
												<h3 class="product-name"><a href="#"><?php echo $row3['product_name'] ?></a></h3>
			    ...
			    <ol>
                        	<li style="size: 18px;">Stunning 13.3-Inch Retina Display with True Tone
</li><br>
                        	<li>Touch ID</li><br>
                        	<li>Dual-core 8th-Generation Intel Core i5 Processor

                            </li><br>
                            <li>Intel UHD Graphics 617

                           </li>
                           <li>Fast SSD Storage</li><br>
                           <li>8GB memory</li><br>
                           <li>Stereo speakers with wider Stereo sound
</li><br>
<li>Two Thunderbolt 3 (USB-C) ports
</li>
